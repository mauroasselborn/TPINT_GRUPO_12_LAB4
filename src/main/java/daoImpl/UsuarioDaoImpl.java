...
public class UsuarioDaoImpl implements UsuarioDao {
	...
	private final String CONSULTA = 
		    ...
		    "SELECT " +
		    "  u.id AS id_usuario, u.nombre_usuario, u.contrasena, u.activo, u.id_tipo_usuario, u.id_cliente," +
		    "  tu.descripcion AS desc_tipo_usuario, " +
		    "  c.dni, " + 
		    "  c.cuil, " + 
		    "  c.nombre AS nombre_cliente, " + 
		    "  c.apellido, " + 
		    "  c.sexo, " + 
		    "  c.id_nacionalidad, n.descripcion AS desc_nacionalidad, " +
		    "  c.fecha_nacimiento, " + 
		    "  c.direccion, " + 
		    "  c.id_localidad, l.nombre AS nombre_localidad, " + 
		    "  c.id_provincia, p.nombre AS nombre_provincia, " + 
