    ...
    <div id="content">
        ...
        <div class="p-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="AltaCuenta.jsp" class="btn btn-primary">Agregar nueva cuenta</a>
            </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-nowrap">
                                <div class="d-flex">
                                    <a href="ModificarCuenta.jsp?id=1" class="btn btn-warning btn-sm btn-action">Modificar</a>
                                    <button class="btn btn-danger btn-sm" onclick="confirmarEliminacion(1)">Eliminar</button>
                                </div>
                            </td>
                        </tr>
