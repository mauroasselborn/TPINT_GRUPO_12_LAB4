      ...
      <div class="card-body">
        <form>
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" value="Juan Pérez" />
            </div>
          </div>
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-4">
              <input type="text" readonly class="form-control" value="$50.000" />
            </div>
            
            <label class="col-sm-2 col-form-label">Cuotas:</label>
            <div class="col-sm-4">
              <input type="text" readonly class="form-control" value="12" />
            </div>
          </div>
