    ...
    <div id="content">
        ...
        <div class="p-4">
            ...
            <div class="scroll-container">
                <table id="tablaClientes" class="table table-bordered table-hover w-100">
                    ...
                    <tbody>
                        <tr>
                            <td>12345678</td><td>20-12345678-3</td><td>Juan</td><td>Pérez</td><td>M</td><td>Argentina</td><td>1990-01-01</td><td>Calle Falsa 123</td><td>Tigre</td><td>Buenos Aires</td><td>juan@mail.com</td><td>1122334455</td>
