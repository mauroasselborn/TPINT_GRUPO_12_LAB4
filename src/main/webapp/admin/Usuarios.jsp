...
<div id="content">
	...
	<div class="p-4">
		<div class="d-flex justify-content-between align-items-center mb-3">
			...
			<a href="#" class="btn btn-primary" onclick="abrirModalAltaUsuario()">Agregar nuevo usuario</a>
		</div>
		<div class="scroll-x">
					...
					<tr>
						...
						<td>
							<div class="d-flex justify-content-center">
								<button class="btn btn-warning btn-sm me-2" onclick="abrirModalUsuario('modificar')">Modificar</button>
								<button class="btn btn-danger btn-sm" onclick="abrirModalEliminarUsuario()">Eliminar</button>
							</div>
						</td>
					</tr>
				</tbody>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-success" form="formAltaUsuario">Guardar Usuario</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="modalEliminarUsuario" tabindex="-1" aria-labelledby="modalEliminarUsuarioLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">¿Estás seguro que querés eliminar este usuario?</div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
...
<div class="modal fade" id="modalUsuario" tabindex="-1" aria-labelledby="modalUsuarioLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalUsuarioLabel">Modificar Usuario</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="formUsuario">
          <div class="row g-3">
            <div class="col-md-6">
              <label class="form-label">Usuario</label>
              <input type="text" class="form-control" value="jadmin" name="usuario">
            </div>
            <div class="col-md-6">
              <label class="form-label">Nombre</label>
            ...
            <div class="col-md-6">
              <label class="form-label">Rol</label>
              <input type="text" class="form-control" value="Administrador" name="rol">
            </div>
            <div class="col-md-6">
              <label class="form-label">Estado</label>
              <input type="text" class="form-control" value="Activo" name="estado">
            </div>
          </div>
        </form>
      </div>
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-success" id="btnGuardarUsuario">Guardar Cambios</button>
      </div>
    </div>
  </div>
</div>
